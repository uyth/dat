...
CREATE TABLE UTE ( 
	...
	temp			FLOAT NOT NULL,
    vaer			VARCHAR(10),
	CONSTRAINT UTE_PK PRIMARY KEY (trening_id),
    CONSTRAINT UTE_FK FOREIGN KEY (trening_id) REFERENCES TRENING(trening_id)
					ON UPDATE CASCADE
                    ON DELETE CASCADE
);
...
CREATE TABLE INNE ( 
	...
	luft			FLOAT,
    tilskuere		INT,
	CONSTRAINT INNE_PK PRIMARY KEY (trening_id),
    CONSTRAINT INNE_FK FOREIGN KEY (trening_id) REFERENCES TRENING(trening_id)
					ON UPDATE CASCADE
                    ON DELETE CASCADE
);
...
INSERT INTO LOGGOVELSER VALUES(2, 1, 2);
